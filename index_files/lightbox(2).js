...
var Lightbox = {
  ...
  slideDownSpeed: 'normal', // Controls the speed of the image details appearance.
  minWidth: 240,
  borderSize : 10,
  boxColor : 'fff',
  fontColor : '000',
  ...
  initialize: function() {
    ...
    var s = Drupal.settings.mr_lightbox2;
  ...
  initList : function() {
    ...
    // 'lightframe', etc.
	  $("a[rel^='lightbox']").addClass('lightbox-processed').click(function(e) {
	      if (Lightbox.disableCloseClick) {
      ...
      $("a[rel^='lightframe']").addClass('lightbox-processed').click(function(e) {
          if (Lightbox.disableCloseClick) {
              $('#lightbox').unbind('click');
              $('#lightbox').click(function() { Lightbox.end('forceClose'); } );
          }
  ...
  changeData: function(imageNum, zoomIn) {
    ...
    if (Lightbox.inprogress === false) {
      ...
      // Set up frame size, etc.
        ...
        $('#frameContainer').html('<iframe id="lightboxFrame" style="display: none;" src="'+src+'" allowfullscreen></iframe>');
